...
class Libc {
  ...
  static final socket = _libc
      .lookupFunction<Int32 Function(Int32, Int32, Int32), int Function(int, int, int)>('socket');

  // int bind(int sockfd, const struct sockaddr *addr, socklen_t addrlen);
  static final bind = _libc.lookupFunction<
      Int32 Function(Int32, Pointer<Void>, Uint32),
      int Function(int, Pointer<Void>, int)>('bind');
  ...
  static final sendto = _libc.lookupFunction<
      ...
      int Function(int, Pointer<Void>, int, int, Pointer<Void>, int)>('sendto');

  // ssize_t recvfrom(int sockfd, void *buf, size_t len, int flags,
  //                  struct sockaddr *src_addr, socklen_t *addrlen);
  static final recvfrom = _libc.lookupFunction<
      IntPtr Function(Int32, Pointer<Void>, Size, Int32, Pointer<Void>, Pointer<Uint32>),
      int Function(int, Pointer<Void>, int, int, Pointer<Void>, Pointer<Uint32>)>('recvfrom');
  ...
  static final strerror = _libc
      .lookupFunction<Pointer<Utf8> Function(Int32), Pointer<Utf8> Function(int)>('strerror');

  // int *__errno_location(void);
  static final _errnoLocation = _libc.lookupFunction<
      Pointer<Int32> Function(), Pointer<Int32> Function()>('__errno_location');
