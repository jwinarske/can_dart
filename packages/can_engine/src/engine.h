...
class Engine {
  public:
    ...
    // Filter chain
    void set_filter_chain(uint32_t sig_idx, const FilterConfig* filters,
                          uint8_t count);
    ...
    int start_periodic_tx(uint32_t can_id, const uint8_t* data, uint8_t dlc,
                          uint32_t interval_ms);
  ...
  private:
    ...
    void update_message_row(uint32_t can_id, const uint8_t* data, uint8_t dlc,
                            uint64_t ts_us);
    void append_frame_row(uint32_t can_id, const uint8_t* data, uint8_t dlc,
                          uint64_t ts_us);
    ...
    static void format_hex(const uint8_t* data, uint8_t dlc, char* out,
                           size_t out_len);
