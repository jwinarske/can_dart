...
/// demo. Laid out to fit the same 480×272 viewport as the dashboard, so the
/// app never resizes between modes.
      ...
      child: ConsoleFrame(
        ...
        child: Column(
          ...
          children: [
            ...
            const Divider(color: MaritimePalette.brass, height: 4),
            const SizedBox(height: 8),
            const Text(
              'Select CAN interface or start demo',
              style: TextStyle(color: MaritimePalette.foam, fontSize: 9),
            ),
            const SizedBox(height: 8),
            if (hasInterfaces) ...[
              SizedBox(
              ...
              const Text(
                ...
                style: TextStyle(color: MaritimePalette.lampAmber, fontSize: 9),
              ),
              const SizedBox(height: 8),
              _brassButton(
                label: 'START DEMO',
